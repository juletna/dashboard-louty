...
Cette commande télécharge les dépendances de compilation dans un dossier temporaire et remplace le bundle intégré à `index.html`. L’utilisation du dashboard reste entièrement hors ligne.
