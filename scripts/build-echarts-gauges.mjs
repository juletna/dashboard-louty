// Rebuild only the ECharts gauge/bar/grid/tooltip/SVG modules inside the offline HTML.
...
`);
  ...
  const inline = '<script>/* Apache ECharts 6.1.0 — GaugeChart, BarChart, GridComponent, MarkLineComponent, TooltipComponent, SVGRenderer; offline bundle.\n' + licenses.replaceAll('*/', '* /') + '\n*/\n' + bundle + '\n</script>';
